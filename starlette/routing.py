...
def request_response(
    func: typing.Callable, request_class: typing.Type[Request] = None
) -> ASGIApp:
    """
        ...
        *,
        ...
        if inspect.isfunction(endpoint) or inspect.ismethod(endpoint):
            ...
            if request_class is not None:
                # Override request class in HTTPEndpoint classes.
                setattr(endpoint, "request_class", request_class)
            self.app = endpoint
