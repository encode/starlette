...
def test_websocket_endpoint_on_connect() -> None:
...
def test_websocket_endpoint_on_receive_bytes() -> None:
    class WebSocketApp(WebSocketEndpoint):
        encoding = "bytes"
...
def test_websocket_endpoint_on_receive_json() -> None:
    class WebSocketApp(WebSocketEndpoint):
        encoding = "json"
...
def test_websocket_endpoint_on_receive_json_binary() -> None:
    class WebSocketApp(WebSocketEndpoint):
        encoding = "json"
...
def test_websocket_endpoint_on_receive_text() -> None:
    class WebSocketApp(WebSocketEndpoint):
        encoding = "text"
...
def test_websocket_endpoint_on_default() -> None:
    class WebSocketApp(WebSocketEndpoint):
        encoding = None
...
def test_websocket_endpoint_on_disconnect() -> None:
    class WebSocketApp(WebSocketEndpoint):
