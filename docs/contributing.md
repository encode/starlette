...
- Write documentation
- Participate in [discussions](https://github.com/encode/starlette/discussions)
...
```shell
$ scripts/test tests/test_requests.py
```
...
For an example, see [#1006](https://github.com/encode/starlette/pull/1202).

Once the release PR is merged, create a
[new release](https://github.com/encode/starlette/releases/new) including:

- Tag version like `0.16.0`.
- Release title `Version 0.16.0`
